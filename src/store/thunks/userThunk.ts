...
export const setUserSubscriptionPaymentFetch =
  (data: boolean) => (dispatch: any) => {
    return new Promise(() => {
...
export const editUserImageFetch =
  (data: { profile_image: File | null }) => (dispatch: any) => {
    return userApi
...
export const subscribeOnUserByLogin =
  (streamer_login: string) => (dispatch: any) => {
    try {
      return userApi
...
export const unsubscribeOnUserByLogin =
  (streamer_login: string) => (dispatch: any) => {
    try {
      return userApi
