...
export const userApi = {
  ...
  getUserPersonalDataApi() {
    return axios
      .get(endpoint + 'get_user_personal_data', config())
      .then((res) => {
        if (res.status === 200) {
          return res.data;
        }
  ...
  editUserPersonalDataApi(data: TUserData) {
    return axios
      .post(endpoint + 'change_user_personal_data', data, config())
      .then((res) => {
        if (res.status === 200) {
          return res.data;
        }
  ...
  uploadUserImage(data: { profile_image: File | null }) {
    return axios
      .post(endpoint + 'profile_image', data, configWithBody())
      .then((res) => {
        if (res.status === 200) {
          return res.data;
        }
  ...
  getUserPopupData(login: string) {
    return axios
      .get(endpoint + `user_pop_up?login=${login}`, config())
      .then((res) => {
        if (res.status === 200) {
          return res.data;
        }
  ...
  getUserSubscriptions() {
    return axios.get(endpoint + 'user_subscriptions', config()).then((res) => {
      if (res.status === 200) {
        return res.data;
      }
  ...
  subscribeOnUserByLogin(data: { streamer_login: string }) {
    return axios.post(endpoint + 'subscribe', data, config()).then((res) => {
      if (res.status === 201) {
        return res.data;
  ...
  unsubscribeOnUserByLogin(data: { streamer_login: string }) {
    return axios.post(endpoint + 'unsubscribe', data, config()).then((res) => {
      if (res.status === 201) {
        return res.data;
      } else if (res.status === 200) {
  ...
  getUserSubscriptionsReports() {
    return axios
      .get(endpoint + 'user_subscriptions_reports', config())
      .then((res) => {
        if (res.status === 200) {
  ...
  getUserSubscriptionsTasks() {
    return axios
      .get(endpoint + 'user_subscriptions_tasks', config())
      .then((res) => {
        if (res.status === 200) {
          return res.data;
        }
