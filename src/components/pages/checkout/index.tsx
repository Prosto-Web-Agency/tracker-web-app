...
function CheckoutPage() {
  ...
  const handleBalanceWheel = () => {
    //@ts-ignore
    dispatch(updateUserWheelData(wheelData)).then(() => {
      router.push('/balance');
    });
  };

  const { slidersData } = useAppSelector((state) => state.balanceWheel);
  const [wheelData, setWheelData] = useState<TReportCheckup>(
    slidersData ?? INIT_SLIDES_STATE,
  );
  ...
  const BALANCE: {
  ...
  }[] = [
    {
      ...
      handleData: (value: number) => {
        setWheelData({ ...wheelData, self_development: value });
      },
    ...
    },
    {
      ...
      image: '/balance/education.svg',
      handleData: (value: number) => {
        setWheelData({ ...wheelData, relationship: value });
      },
      value: 'relationship',
    },
    {
      ...
      image: '/balance/education.svg',
      handleData: (value: number) => {
        setWheelData({ ...wheelData, career: value });
      },
      value: 'career',
    },
    {
      ...
      image: '/balance/education.svg',
      handleData: (value: number) => {
        setWheelData({ ...wheelData, rest: value });
      },
      value: 'rest',
    },
    {
      ...
      image: '/balance/education.svg',
      handleData: (value: number) => {
        setWheelData({ ...wheelData, environment: value });
      },
      value: 'environment',
    },
    {
      ...
      image: '/balance/education.svg',
      handleData: (value: number) => {
        setWheelData({ ...wheelData, income: value });
      },
      value: 'income',
    },
    {
      ...
      image: '/balance/education.svg',
      handleData: (value: number) => {
        setWheelData({ ...wheelData, creation: value });
      },
      value: 'creation',
    },
    {
      ...
      image: '/balance/education.svg',
      handleData: (value: number) => {
        setWheelData({ ...wheelData, health: value });
      },
      value: 'health',
    },
  ];
      ...
      >
        <div>
          <div className="flex flex-col items-center px-6">
            ...
            <h1 className="RECsText text-20 md:text-[15px] -bold">Чекап</h1>
          </div>
        </div>

        <div className="flex flex-col gap-5 p-4 pt-10">
          <ThemeProvider theme={theme}>
            {BALANCE.map(({ value, name, handleData, image }, index) => (
              <SliderBalance
