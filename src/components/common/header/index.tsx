...
export default function Header({
  ...
  useEffect(() => {
    TABS.map(
      ({ link, title }) =>
        link === window.location.pathname && setActiveTab(title),
    );
        ...
        <div className="mx-auto w-full max-w-[1400px] h-full flex justify-between items-center">
          <Link href={'/'} className="flex items-center gap-2 px-6 z-[100]">
            <Image
              ...
              alt="RECs"
            />
            <h1 className="RECsText text-text-m-bold">TRAKER STATS</h1>
          </Link>
          ...
          <button
            ...
            className="hidden h-[90px] z-[210] justify-center items-center pr-[30px] lg:flex"
          >
