...
export default function RateCard({name, position}: TCardRate) {
    return (
        <div className="w-full duration-100 hover:border-2 border-white max-w-full h-[52px] items-center p-2 pr-5 rounded-full flex justify-between raiting-top-one">
