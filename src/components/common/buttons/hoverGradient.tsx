...
const HoverGradientButton: React.FC<HoverGradientButtonProps> = ({
  ...
  return (
    <button
      className={`w-full hoveredMenu duration-300 hover:scale-[1.03] flex justify-center items-center rounded-4 min-w-[364px] py-5 ss_lg:min-w-full bg-white text-heading-ss-bold lg:text-text-m-bold ${className}`}
      onClick={onClick}
    >
